<template>
    ...
    <div id="MapView">
        <Search @ResetFeature="ResetFeature" />
    </div>
...
export default {
    ...
    methods:{
        ...
        LoadMap(){
            ...
            }).then(([Map,MapView,FeatureLayer, Graphic, urlUtils,Polyline]) => {
